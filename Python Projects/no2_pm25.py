import pandas as pd
air_quality_no2 = pd.read_csv(r'air_quality_no2_long.csv',parse_dates=True)
air_quality_no2 = air_quality_no2[["date.utc", "location", "parameter", "value"]]
#print(air_quality_no2.head())

air_quality_pm25 = pd.read_csv(r'air_quality_pm25_long.csv',parse_dates=True)
...
stations_coord = pd.read_csv(r'air_quality_stations.csv')
...
air_quality_parameters = pd.read_csv(r"air_quality_parameters.csv")
